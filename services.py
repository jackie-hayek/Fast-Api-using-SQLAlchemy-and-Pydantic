...
def get_student_by_major(db: Session, major: str):
...
def add_new_student(db: Session, studentx: SchemaStudent) -> object:
...
def update_student_by_email(db: Session, email: str, studentx:SchemaStudent):
    ...
    #student_to_update.email = studentx.email
